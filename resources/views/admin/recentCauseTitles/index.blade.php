...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All recentCauseTitles</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{URL::to('/dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active">recentCauseTitles</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">recentCauseTitles</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('recent-cause-titles.create')}}" class="btn btn-primary add-new mb-2">Add recentCauseTitles</a>
            ...
            $(document).on('click', '.delete-data', function(e){
                ...
                if(confirm('Do you want to delete this?'))
                {
                    $.ajax({
                        ...
                        url: "{{url('/recent-cause-titles')}}/"+data_id,
                        type:"DELETE",
                        dataType:"json",
