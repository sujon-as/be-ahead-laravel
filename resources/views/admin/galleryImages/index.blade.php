...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Gallery Images</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('gallery-images.create')}}" class="btn btn-primary add-new mb-2">Add Gallery Images</a>
            ...
            $(document).on('click', '.delete-data', function(e){
                ...
                if(confirm('Do you want to delete this?'))
                {
                    $.ajax({
                        ...
                        url: "{{url('/gallery-images')}}/"+data_id,
                        type:"DELETE",
                        dataType:"json",
