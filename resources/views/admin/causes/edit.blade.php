    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('front-causes.update',$front_cause->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="dropify"
                                        data-height="150"
                                        data-default-file="{{asset($front_cause->img)}}"
                                    />
                                    @error('img')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        required=""
                                        value="{{old('percentage', $front_cause->percentage)}}"
                                    >
                                    @error('percentage')
                                    <span class="alert alert-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! old('content', $front_cause->content) !!}
                                </textarea>
                                    @error('content')
                                    <span class="alert alert-danger">{{ $message }}</span>
                                    @enderror
