...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('front-causes.create')}}" class="btn btn-primary add-new mb-2">Add Causes</a>
