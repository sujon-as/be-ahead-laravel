...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('sliders.create')}}" class="btn btn-primary add-new mb-2">Add Slider</a>
        ...
        $(document).ready(function(){
            ...
            var table = $('#table-data').DataTable({
                ...
                columns: [
                    ...
                    {data: 'title_3', name: 'title_3'},
                    {data: 'bg_img', name: 'bg_img'},
                    {data: 'marker_img', name: 'marker_img'},
