...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">All Appointment Title</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{URL::to('/dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Appointment Title</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="{{route('appointment-titles.create')}}" class="btn btn-primary add-new mb-2">Add Appointment Title</a>
            ...
            $(document).on('click', '.delete-data', function(e){
                ...
                if(confirm('Do you want to delete this?'))
                {
                    $.ajax({
                        ...
                        url: "{{url('/appointment-titles')}}/"+data_id,
                        type:"DELETE",
                        dataType:"json",
